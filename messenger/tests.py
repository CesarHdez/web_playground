...
class ThreadTestCase(TestCase):
    ...
    def test_add_users_to_thead(self):
    ...
    def test_add_message_to_thread(self):
        ...
        message2 = Message.objects.create(user= self.user2, content="Hi")
    ...
    def test_add_message_from_user_not_in_thread(self):
        ...
        message1 = Message.objects.create(user= self.user1, content="Hello There")
        message2 = Message.objects.create(user= self.user2, content="Hi")
        message3 = Message.objects.create(user= self.user3, content="I´m here")
